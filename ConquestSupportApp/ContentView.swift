...
struct ContentView: View {
    ...
    /// Max logo height; used for GeometryReader and image frame so logo stays balanced with buttons.
    private let logoMaxHeight: CGFloat = 260
